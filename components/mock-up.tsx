...
const footerNavigation = {
  solutions: [
    ...
    { name: "PCB Assembly", href: "#" },
    { name: "Final assembly", href: "#" },
    { name: "Optical inspection", href: "#" },
  ],
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  ...
                  large-scale manufacturing, we have you covered. Partner with
                  us today.
                </p>
          ...
          <div className="mt-16 flex justify-center">
            <p className="relative rounded-full px-4 py-1.5 text-sm leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <a href="#" className="font-semibold text-indigo-600">
                ...
                sales <span aria-hidden="true">&rarr;</span>
              </a>
            </p>
          </div>
        </div>
        ...
        <div className="relative -z-10 mt-32 px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Your strategic partner in producing the highest quality
              electronics
            </h2>
